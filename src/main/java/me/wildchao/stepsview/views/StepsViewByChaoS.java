 ...
 */
public class StepsViewByChaoS extends View {
    ...
    public StepsViewByChaoS(Context context, int anchorCount, int anchorColor, int trackColor, int orientation) {
        super(context);
    ...
    public StepsViewByChaoS(Context context, AttributeSet attrs) {
        super(context, attrs);
        init();
    }
    ...
    protected void onDraw(Canvas canvas) {
        ...
        setAnchorCount(mAnchorCount, mOrientation);
    ...
    /**
     * 设置锚点数量，以及生成锚点坐标，轨迹坐标
     *
     * @param count
     */
    public void setAnchorCount(int count, int orientation) {
        mAnchorCount = count; // 重新计算锚点数量
        switch (orientation) {
